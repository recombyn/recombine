/**
 * World-level SVG context (`tl-svg-context` inspired).
 * Holds shared defs only — not artboard content. Content lives in HTML frames.
 */
export default function SvgContextLayer() {
  return (
